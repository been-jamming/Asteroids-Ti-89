	0b00000000000000000000000000000000,
	0b11111111000000111111111100000000,
	0b11111111100001111111111110000000,
	0b11111111110001111111111100000000,
	0b11000111110001111000000000000000,
	0b11000011110001110000000000000000,
	0b11000001110001111000000000000000,
	0b11000001110001111111111100000000,
	0b11000001110001111111111110000000,
	0b11000001110000111111111110000000,
	0b11000001110000000000011110000000,
	0b11000011110000000000001110000000,
	0b11000111110000000000011110000000,
	0b11111111110000111111111110000000,
	0b11111111100001111111111110000000,
	0b11111111000000111111111100000000
};
...
void display_explosion(unsigned char i){
	if(explosions[i].lifetime){
		if(explosions[i].frame < 3){
			...
			ClipSprite16_OR_R(explosions[i].x - 6, explosions[i].y - 6, 12, explosion_sprite1, virtual);
		} else {
			ClipSprite16_OR_R(explosions[i].x - 6, explosions[i].y - 6, 12, explosion_sprite2, virtual);
		}
...
void display_title(){
	Sprite32_OR(0, 0, 49, title1, virtual);
	Sprite32_OR(32, 0, 49, title2, virtual);
	Sprite32_OR(64, 0, 49, title3, virtual);
	Sprite32_OR(96, 0, 49, title4, virtual);
	Sprite32_OR(128, 0, 49, title5, virtual);
}
...
DEFINE_INT_HANDLER (frame_update){
	...
	while(!OSdequeue(&key, kbq)){
		if(key == KEY_ESC){
			quit = true;
		} else if(key == KEY_DOWN && !game_over){
			shoot_bullet();
		}
		key_pressed = true;
	}
	...
	if((frame < 1080 && !(frame%36)) || (frame >= 1080 && frame < 2160 && !(frame%18)) || (frame >= 2160 && frame < 4320 && !(frame%9)) || (frame >= 4320)){
...
void _main(){
	...
	while(!key_pressed){
		if(do_update){
			...
			DrawStr(0, 92, "By Ben Jones", A_REVERSE);
			FastFillRect(virtual, 20, 59, 140, 68, A_REVERSE);
			FastOutlineRect(virtual, 19, 58, 141, 69, A_NORMAL);
			DrawStr(20, 60, "Press a key to start", A_NORMAL);
	...
	score = frame/18;
	sprintf(buffer, "Score: %d seconds", score);
	str_width1 = DrawStrWidth("Game Over!", A_NORMAL);
	str_width2 = DrawStrWidth(buffer, A_NORMAL);
	string_x1 = 80 - str_width1/2;
	string_x2 = 80 - str_width2/2;
	key_pressed = false;
	
	while(!quit && !key_pressed){
		if(do_update){
			do_update = false;
			out_of_bounds();
			split_asteroids();
			...
			FastFillRect(virtual, string_x2 - 2, 30, string_x2 + str_width2 + 2, 70, A_REVERSE);
			FastOutlineRect(virtual, string_x2 - 2, 30, string_x2 + str_width2 + 2, 70, A_NORMAL);
			DrawStr(string_x1, 32, "Game Over!", A_NORMAL);
			DrawStr(string_x2, 60, buffer,  A_NORMAL);
			memcpy(LCD_MEM, virtual, LCD_SIZE);
		}
	}
	free(clip_coords);
